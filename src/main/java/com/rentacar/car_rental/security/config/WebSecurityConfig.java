package com.rentacar.car_rental.security.config;

import com.rentacar.car_rental.security.jwt.AuthEntryPointJwt;
import com.rentacar.car_rental.security.jwt.AuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/car-rental/api/user/**", "/car-rental/api/files/**")
                .permitAll()
                .anyRequest()
                .authenticated();
